...
public sealed class MetaTest : BaseTest
{
    ...
    internal void ToRelation_Meta1_RelationObject()
    {
        ...
        var meta = new Meta(2, (byte)EntityType.Relation, 1011, _faker.Random.Number(int.MinValue,int.MaxValue), 786448L, "ability2book", _faker.Random.String(), "book2ability", true);
