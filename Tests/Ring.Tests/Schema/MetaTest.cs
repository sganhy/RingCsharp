...
public sealed class MetaTest : BaseTest
{
    ...
    internal void ToField_Meta1_FieldObject()
    {
        ...
        var meta = new Meta(2, (byte)EntityType.Field, 1011, 16, 10493964+16, "name",_faker.Random.String(), null, true);
    ...
    internal void ToField_Meta2_FieldObject()
    {
        // arrange 
        // eg. from rpg_schema.xml => ability.name (generated by golang version of ring) 
        var meta = new Meta(6, (byte)EntityType.Field, 1021, 16, 1712142+16, "isbn", _faker.Random.String(), "Test2", false);
        var exepectedFieldType = FieldType.String;
    ...
    internal void ToField_Meta3_FieldObject()
    {
        // arrange 
        // eg. from rpg_schema.xml => ability.name (generated by golang version of ring) 
        var meta = new Meta(4, (byte)EntityType.Field, 1032 , 2, 6+32, "status", _faker.Random.String(), "Test3", true);
