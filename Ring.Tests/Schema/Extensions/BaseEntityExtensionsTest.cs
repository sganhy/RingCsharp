...
public sealed class BaseEntityExtensionsTest : BaseTest
{
    ...
    internal void GetStringCode_AnonymousInput_StringCode()
    {
        ...
        var field = new Field(id, name, name, description, fieldType, size, defaultValue, SearchableType.IgnoreCase, true, true, true, false);
        var expectedValue = $"{field.Active}{sep}{field.Baseline}{sep}{field.Description}{sep}{field.Id}{sep}{field.Name}{sep}{field.PhysicalName}";
