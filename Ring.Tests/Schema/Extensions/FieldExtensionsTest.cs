...
public class FieldExtensionsTest : BaseTest
{
    ...
    internal void ToMeta_Field2_MetaValue()
    {
        ...
        var size = _faker.Random.Number(0,int.MaxValue);
        var field = new Field(id, name, description, fieldType, size, defaultValue, SearchableType.IngoreCaseAndDiacritics, false, false, false, true);
    ...
    internal void GetHashCode_FieldHashEqual_True()
    {
        ...
        var field1 = new Field(id, name, description, fieldType, size, defaultValue, SearchableType.IngoreCaseAndDiacritics, false, false, false, true);
        var field2 = new Field(id, name, description, fieldType, size, defaultValue, SearchableType.IngoreCaseAndDiacritics, false, false, false, true);
    ...
    internal void GetHashCode_FieldHashEqual_False()
    {
        ...
        var defaultValue = _faker.Random.Bool() ? null : _faker.Random.String();
        var size = _faker.Random.Number(int.MinValue,int.MaxValue);
        var field1 = new Field(id, name, description, fieldType, size, defaultValue, SearchableType.IngoreCase, false, false, false, true);
        var field2 = new Field(id, name, description, fieldType, size, defaultValue, SearchableType.IngoreCase, false, false, true, true);
        var field3 = new Field(id, name, description, fieldType, size, defaultValue, SearchableType.IngoreCaseAndDiacritics, false, false, false, true);
