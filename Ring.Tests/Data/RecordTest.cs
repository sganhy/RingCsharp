...
#pragma warning restore CS8620
    ...
    public void SetField_DateTime2_ReturnIso8601Format()
    {
        ...
        // assert
        Assert.Equal("2005-12-12T14:17:16.015000Z", rcd.GetField("entry_time"));
    }
    ...
    public void SetField_DateTimeOffset_ReturnIso8601Format()
    {
        ...
        // assert
        Assert.Equal("2006-10-14T14:18:19.015000Z", rcd.GetField("entry_time"));
    }
    ...
    public void SetField_DateTimeNow_ReturnIso8601Format()
    {
        ...
        // assert
        Assert.Equal(dt.ToString("yyyy-MM-ddTHH:mm:ss.ffffffZ"), rcd.GetField("entry_time"));
    }
    ...
    public void SetField_LongDateTime_ReturnIso8601Format()
    {
        ...
        const string expectedResult=@"2005-12-12T18:17:16.015116-07:45";
    ...
    public void ClearData_AnonymousRecord_DataResetToNull()
    {
        ...
        for (var i = 0; i < rcd2.Table.RecordSize; ++i)
        {
            Assert.Null(rcd2[i]);
        }
    }
    ...
    private string?[] GetBucket(Table table, int recordCount, int maxStringSize)
    {
        ...
        var itemsCount = table.Relations.Length + table.Fields.Length;
        for (var i = 0; i < bucket.Length; i++)
        {
            // don't fill flag string (last string into array)
            if (i==0 || i% table.RecordSize != itemsCount) 
