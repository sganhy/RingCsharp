...
internal readonly struct Meta : IEquatable<Meta>
{
    ...
    internal static long SetTableAllowAttributeExtension(long flags, bool value) => WriteFlag(flags, MetaFlag.TableAllowEAV, value); // Code size: 14 (0xe)
    ...
    internal bool IsTableAllowAttributeExtension() => (Flags & (long)MetaFlag.TableAllowEAV) != 0; // Code size: 18 (0x12)
