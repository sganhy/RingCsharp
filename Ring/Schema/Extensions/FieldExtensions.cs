...
{
    private static readonly string _primaryKeyFieldName = "id";
    private static readonly string _primaryKeyDescription = "Internal record number";
    private static readonly Field _defaultPrimaryKeyInt64 =
        new(1, _primaryKeyFieldName, _primaryKeyDescription, FieldType.Long, 0, null, false, true, true, true, false);
    private static readonly Field _defaultPrimaryKeyInt32 =
        new(1, _primaryKeyFieldName, _primaryKeyDescription, FieldType.Int, 0, null, false, true, true, true, false);
    private static readonly Field _defaultPrimaryKeyInt16 =
        new(1, _primaryKeyFieldName, _primaryKeyDescription, FieldType.Short, 0, null, false, true, true, true, false);
    private static readonly Field _defaultPrimaryKeyInt08 =
        new(1, _primaryKeyFieldName, _primaryKeyDescription, FieldType.Byte, 0, null, false, true, true, true, false);
