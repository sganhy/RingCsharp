...
internal sealed class Index : BaseEntity
{
	...
	/// 	Ctor
	/// </summary>
	internal Index(int id, string name, string physicalName, string? description, Column[] columns, string columnList, bool unique, bool bitmap, bool active, bool baseline)
